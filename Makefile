...
SRC = $(SRC_DIR)/main.c $(SRC_DIR)/errors.c $(SRC_DIR)/init.c \
			...
			$(SRC_DIR)/parser/validation_helpers.c $(SRC_DIR)/parser/utils.c \
			$(SRC_DIR)/events/setup.c $(SRC_DIR)/events/events.c $(SRC_DIR)/free.c \
			$(SRC_DIR)/events/translation.c $(SRC_DIR)/events/translate_objects.c \
			...
			$(SRC_DIR)/render/cylinder_utils.c $(SRC_DIR)/render/color.c \
			$(SRC_DIR)/render/camera.c $(SRC_DIR)/render/shading.c \
			$(SRC_DIR)/render/shading_utils.c $(SRC_DIR)/render/light.c \
			$(SRC_DIR)/debug.c $(SRC_DIR)/render/render.c \
